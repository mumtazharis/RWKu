...
@section('content')
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('kepemilikan') }}" class="form-horizontal">
                @csrf
                <div class="form-group row">
                    <label class="col-2 control-label col-form-label">ID</label>
                    <div class="col-10">
                        <input type="text" class="form-control" id="kepemilikan_id" name="kepemilikan_id"
                            value="{{ old('kepemilikan_id') }}" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input type="text" class="form-control" id="keluarga_ditanggung" name="keluarga_ditanggung"
                            value="{{ old('keluarga_ditanggung') }}" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input type="text" class="form-control" id="pajak_motor" name="pajak_motor"
                            value="{{ old('pajak_motor') }}" required>
                        @error('pajak_motor')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input type="text" class="form-control" id="pajak_mobil" name="pajak_mobil"
                            value="{{ old('pajak_mobil') }}" required>
                        @error('pajak_mobil')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input type="text" class="form-control" id="pajak_bumi_bangunan" name="pajak_bumi_bangunan"
                            value="{{ old('pajak_bumi_bangunan') }}" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input type="text" class="form-control" id="tagihan_air" name="tagihan_air"
                            value="{{ old('tagihan_air') }}" required>
                        @error('tagihan_air')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
