    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            @empty($keluarga)
                ...
                <a href="{{ url('rt/keluarga') }}" class="btn btn-sm btn-default mt-2">Kembali</a>
            @else
        <form method="POST" action="{{ url('rt/keluarga/' . $keluarga->nomor_kk) }}" class="form-horizontal">
            @csrf
            @method('PUT')
            ...
            <div class="form-group row">
                <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <a href="{{ url('rt/keluarga') }}" class="btn btn-default">Kembali</a>
                </div>
            </div>
        </form>
        @endempty
