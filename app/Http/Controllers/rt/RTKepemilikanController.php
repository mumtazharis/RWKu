...
class RTKepemilikanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('rt.kepemilikan.index', [
    ...
    public function list(Request $request)
    {
        ...
        $dataKepemilikan = KepemilikanModel::select('kepemilikan.kepemilikan_id', 'kepemilikan.nomor_kk', 'kepemilikan.penghasilan', 'kepemilikan.keluarga_ditanggung', 'kepemilikan.pajak_motor', 'kepemilikan.pajak_mobil', 'kepemilikan.pajak_bumi_bangunan', 'kepemilikan.tagihan_air', 'kepemilikan.tagihan_listrik', 'kepemilikan.hutang')
        ->join('keluarga', 'kepemilikan.nomor_kk', '=', 'keluarga.nomor_kk')
        ->where('keluarga.alamat_kk', $rt->rt)
        ->with('keluarga')
        ->get();
        ...
        return DataTables::of($dataKepemilikan)
            ...
            ->addColumn('aksi', function ($kepemilikan) { // Add action column
                $btn = '<a href="' . url('rt/kepemilikan/' . $kepemilikan->kepemilikan_id) . '" class="btn btn-info btn-sm">Detail</a> ';
                $btn .= '<a href="' . url('rt/kepemilikan/' . $kepemilikan->kepemilikan_id . '/edit') . '" class="btn btn-warning btn-sm">Edit</a> ';
                return $btn;
            })
...
public function show($id)
{
    ...
    return view('rt.kepemilikan.show', [
        'breadcrumb' => $breadcrumb,
        'page' => $page,
        'kepemilikan' => $kepemilikan,
        'activeSubMenu' => $activeSubMenu,
...
public function edit($id)
{
   ...
   return view('rt.kepemilikan.edit', [
       'breadcrumb' => $breadcrumb,
       'page' => $page,
       'kepemilikan' => $kepemilikan,
       'activeSubMenu' => $activeSubMenu,
...
public function update(Request $request, $id)
    ...
    return redirect('rt/kepemilikan')->with('success', 'Data kepemilikan berhasil diubah');
}
