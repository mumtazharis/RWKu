...
class RTDokumentasiController extends Controller
{
    public function index(){
        ...
        return view('rt.dokumentasi.index', ['breadcrumb' => $breadcrumb, 'page' => $page,'activeMenu' => $activeMenu, 'activeSubMenu' => $activeSubMenu, 'rt' => $rt]);
    }
    ...
    public function create(){
        ...
        return view('rt.dokumentasi.create', ['breadcrumb' => $breadcrumb, 'page' => $page,'kegiatan' => $kegiatan ,'activeMenu' => $activeMenu, 'activeSubMenu' => $activeSubMenu]);
    }
    ...
    public function store(Request $request){
        ...
        return redirect('rt/dokumentasi')->with('success', 'Data kegiatan berhasil disimpan');
    }
    ...
    public function edit(string $id){
        ...
        $activeMenu = 'kegiatan';
        $activeSubMenu = 'dokumentasi_list';
        return view('rt.dokumentasi.edit', ['breadcrumb' => $breadcrumb, 'page' => $page, 'kegiatan' => $kegiatan, 'dokumentasi' => $dokumentasi,'activeMenu' => $activeMenu, 'activeSubMenu' => $activeSubMenu]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('rt/dokumentasi')->with('success', 'Data berhasil diperbarui!');
    }
